...
> 코로나19 비대면 시기, 회사에서 운영하던 **ZOOM 아이스브레이킹 카드 게임**을 포트폴리오용으로 재구성했습니다.
> 원본은 회사 내부 서비스이며, 현재는 운영하지 않아서 **프론트엔드 데모·기술 패턴 공개** 목적의 sanitized 버전입니다.
...
| UI 에셋 | PNG 아이콘·로고 | 텍스트·이모지 기반 UI |
| 배포 | 회사 서버 | Vercel |
